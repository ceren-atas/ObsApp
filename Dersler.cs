...
namespace ObsApp
{
    public partial class Dersler : Form
    {
        ...
        private void btn_ekle_Click(object sender, EventArgs e)
        {
            ...
            tblDersler dersler = new tblDersler { DersAdi = txtDersAdi.Text, DersKodu = txtdersKodu.Text };
        ...
        private void btn_sil_Click(object sender, EventArgs e)
        {
            using (OkulDbContext ctx = new OkulDbContext())
            {
                var dersler = ctx.Dersler.Where(d => d.DersKodu == txtdersKodu.Text).FirstOrDefault();
        ...
        private void btn_guncelle_Click(object sender, EventArgs e)
        {
            using (OkulDbContext ctx = new OkulDbContext())
            {
                var ders = ctx.Dersler.Where(d => d.DersKodu == txtdersKodu.Text).FirstOrDefault();
